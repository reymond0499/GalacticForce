  ...
  return (
    <div className="search">
        <div className="search-box">
            ...
            <input placeholder="Buscar..." className="input"  value={inputValue} onChange={handleInputChange} type="text"></input>
                <div className="search-box-icon">
                    <button className="btn-icon-content" onClick={() => setInputValue(inputValue)}>
